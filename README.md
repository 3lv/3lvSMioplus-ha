# Sequent Microsystems Template Testing SMioplus Home Assistant Integration

Integrate [Template Testing SMioplus]()
...
- [video]() for steps 4. and 5. (replace SMioplus-ha with SMioplus-ha)
